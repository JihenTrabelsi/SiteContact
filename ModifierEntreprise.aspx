...
<body>
    <form id="form1" runat="server">
                ...
                <script>
                    ...
                    function Modifier() {
                        callUpdate.PerformCallback();
                    }

                    function EndCalUpd(s,e) {
                        var choix = s.cp_Update;

                        if (choix == "Update") {
                           
                            txterror.SetText("Modifiée avec succés");
                            alertPopup.Show();
                        }
                        else {
        ...
        <dx:ASPxFormLayout runat="server" ID="FormLayoutModifEntreprise" Width="100%" ClientInstanceName="FormLayoutModifEntreprise" Theme="Glass">
            <Items>
                            ...
                            <LayoutItemNestedControlCollection> 
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxButton runat="server" Text="Enregistrer" Width="100px" Theme="Glass" AutoPostBack="false" ID="btnEnregistrer">
                                        ...
                                        <ClientSideEvents Click="Modifier"/>
                                    </dx:ASPxButton>
        ...
        <dx:ASPxCallback ID="callUpdate" ClientInstanceName="callUpdate" runat="server" OnCallback="callUpdate_Callback" >
            <ClientSideEvents EndCallback="function(s,e){EndCalUpd(s,e);}" />
        </dx:ASPxCallback>
